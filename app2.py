...
ax1[0].set_title('Market price', fontsize = 50, fontweight ="bold")
...
sns.lineplot(data = plot_q, x='beta', y='P', label='market price', ax=ax1[0], linewidth=3)
...
ax2[0].set_title('Firm production', fontsize = 50, fontweight ="bold")
ax2[0].set_xlabel('price elasticity of demand'+' ('r'$1 /\beta$'+')', size=40)
ax2[0].set_ylabel('quantity', size=40)
ax2[0].tick_params(axis='both', which='major', labelsize=30)
sns.lineplot(data = plot_q, x='beta', y=0, label=name_list[0], ax=ax2[0], linewidth=3)
sns.lineplot(data = plot_q, x='beta', y=1, label=name_list[1], ax=ax2[0], linewidth=3)
sns.lineplot(data = plot_q, x='beta', y=2, label=name_list[2], ax=ax2[0], linewidth=3)
