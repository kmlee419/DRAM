...
c_list[1] = st.sidebar.number_input('Insert firm 1\'s marginal cost (c2)', min_value = c_list[0], step=0.01)
name_list[1] = "firm 2 (c2)"
c_list[2] = st.sidebar.number_input('Insert firm 1\'s marginal cost (c3)', min_value = c_list[1], step=0.01)
name_list[2] = "firm 3 (c3)"
c_list[3] = st.sidebar.number_input('Insert firm 1\'s marginal cost (c4)', min_value = c_list[2], step=0.01)
...
ax1.set_xlabel('price elasticity of demand'+' ('r'$1 /\beta$'+')', size=20)
ax1.set_ylabel('quantity', size=20)
...
ax2.set_xlabel('price elasticity of demand'+' ('r'$1 /\beta$'+')', size=20)
ax2.set_ylabel('quantity', size=20)
sns.lineplot(data = plot_q, x='beta', y='Q', label='total Q', ax=ax2, linewidth=3)
ax2.legend(loc="upper left", prop={'size': 15})

fig3, ax3 = plt.subplots(figsize=(10,5))
ax3.set_xlabel('price elasticity of demand'+' ('r'$1 /\beta$'+')', size=20)
ax3.set_ylabel('price', size=20)
sns.lineplot(data = plot_q, x='beta', y='P', label='market price', ax=ax3, linewidth=3)
ax3.legend(loc="upper left", prop={'size': 15})

fig4, ax4 = plt.subplots(figsize=(10,5))
ax4.set_xlabel('price elasticity of demand'+' ('r'$1 /\beta$'+')', size=20)
