...
beta_range = np.arange(2./3.+0.0001, 4./3.-0.0001, 0.01)
...
plot_q['b1p11'] = plot_q['b1'] -  plot_q['p1']
plot_q['b2p21'] = plot_q['b2'] -  plot_q['p2']
plot_q['b3p31'] = plot_q['b3'] -  plot_q['p3']
plot_q['rb1p11'] = plot_q['b1'] /  plot_q['p1']
plot_q['rb2p21'] = plot_q['b2'] /  plot_q['p2']
plot_q['rb3p31'] = plot_q['b3'] /  plot_q['p3']
...
#sns.lineplot(data = plot_q, x='beta', y='s4', label=name_list[2], ax=ax4[0][1], linewidth=3)
#sns.lineplot(data = plot_q, x='beta', y='zero', legend=False, ax=ax3[0][1], linewidth=3, linestyle='--', color='black')
...
sns.lineplot(data = plot_q, x='beta', y='p1', label=name_list[0], ax=ax5[0][1], linewidth=3)
sns.lineplot(data = plot_q, x='beta', y='p2', label=name_list[1], ax=ax5[0][1], linewidth=3)
sns.lineplot(data = plot_q, x='beta', y='p3', label=name_list[2], ax=ax5[0][1], linewidth=3)
#sns.lineplot(data = plot_q, x='beta', y='p41', label=name_list[2], ax=ax5[0][1], linewidth=3)
#sns.lineplot(data = plot_q, x='beta', y='zero', legend=False, ax=ax3[0][1], linewidth=3, linestyle='--', color='black')
